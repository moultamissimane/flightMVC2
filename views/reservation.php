            ...
            <div class="m-10 xl:w-3/4 sm:w-full relative">
                ...
                <div class="max-w-full  bg-white flex flex-col rounded overflow-hidden shadow-lg">
                    <div class="flex flex-row items-baseline flex-nowrap bg-gray-100 p-2">
                        ...
                        <p class="ml-2 font-normal text-gray-500"><?php echo $f['departure'] ?></p>
                    </div>
                    ...
                    <div class="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap ">
                        <div class="flex flex-row place-items-center p-2">
                            ...
                            <div class="flex flex-col ml-2">
                                <p class="text-xs text-gray-500 font-bold"><?php echo $f['name'] ?></p>
                                <p class="text-xs text-gray-500"><?php echo $f['abreviation'] ?></p>
                            </div>
                        </div>

                        <div class="flex flex-col p-2">
                            <p class="font-bold"><?php echo $f['departure'] ?></p>
                            <p class="text-gray-500"><?php echo $f['city_from'] ?></p>
                        </div>
                        <div class="flex flex-col flex-wrap p-2">
                            <p class="font-bold"><?php echo $f['arrive'] ?></p>
                            <p class="text-gray-500"><?php echo $f['city_to'] ?></p>
                        </div>
                    </div>
