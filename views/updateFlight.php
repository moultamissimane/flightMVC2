        ...
        <div class="bg-gray-50 flex-grow p-6">
            <form method="POST" id="form" class="needs-validation" novalidate>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="city_to" id="city_to" value="<?php echo $flight->city_to; ?>" placeholder="Paris" required class="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                </div>
                <div class="mb-4">
                    <label for="full_name" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Departure</label>
                    <input type="time" name="departure" id="departure" value="<?php echo $flight->departure; ?>" placeholder="Casablanca" required class="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                </div>
                <div class="mb-4">
                    <label for="full_name" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Price</label>
                    <input type="text" name="price" id="price" value="<?php echo $flight->price; ?>" placeholder="400$" required class="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="seats" id="seats" value="<?php echo $flight->seats; ?>" placeholder="n°1" required class="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                </div>
                <div class="mb-3">
